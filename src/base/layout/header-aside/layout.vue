...
<!--          <d2-header-color/>-->
      ...
      <div class="d2-theme-container" flex-box="1" flex>
        <!-- 主体 侧边栏 -->
          <div
            :hidden="this.searchActive === true"
            flex-box="0"
            ref="aside"
            class="d2-theme-container-aside d2-theme-container-transition"

            :style="{
            width: asideCollapse ? asideWidthCollapse : asideWidth,
            opacity: this.searchActive ? 0.5 : 1,
            borderRightWidth: asideCollapse ? '0px' : '1px'
          }">
            <my-aside-left ></my-aside-left>
          </div>
...
<script>
import myAsideLeft from './components/my_aside_left'
...
<style lang="scss">
// 注册主题
@import '~@/base/assets/style/theme/register.scss';
</style>
